...
export default class Free extends React.Component {
  ...
  render() {
    return (<div className={styles.result_example}>
      <div className={styles.sub_title}>支付成功</div>
  <Result
  ...
  />
  <WhiteSpace />
  <div className={styles.sub_title}>验证成功</div>
  <Result
  buttonText={"返回"}
  ...
  />
  <WhiteSpace />
  <div className={styles.sub_title}>支付失败</div>
  <Result
  ...
  />
  <WhiteSpace />
  <div className={styles.sub_title}>等待处理</div>
  <Result
  ...
  />
  <WhiteSpace />
  <div className={styles.sub_title}>操作失败</div>
  <Result
